  ...
  const teamMembers = [
    {
      ...
      role: "Team Lead, Backend Developer & Frontend Designer",
      bio: "Arunava is the driving force behind our team, ensuring smooth collaboration and efficient development. His backend expertise ensures seamless performance, and he also plays a crucial role in frontend designing.",
      image: arunavaImg,
    ...
    {
      name: "Manik",
      role: "Product Manager, Backend Developer & Integration Specialist",
      bio: "Manik specializes in building robust and optimized backend systems. His problem-solving skills and keen eye for efficiency ensure that our project runs seamlessly behind the scenes. He also plays a key role in connecting the backend with the frontend, ensuring smooth data flow and functionality.",
      image: manikImg,
